...
def start_game():
  ...
  result=client_utils.searchImg('lineage_symbol.png',beforeDelay=0, afterDelay=0, _region=(0,0,1920,1080), accuracy=0.7)
  result=client_utils.searchImg('lineage_symbol_2.png',beforeDelay=0, afterDelay=0, chkCnt=2, _region=(0,0,1920,1080), accuracy=0.7)
